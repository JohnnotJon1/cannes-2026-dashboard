      ...
      <div className="space-y-5 p-5 sm:p-6">
        ...
        {url && !assistOpen && (
          <button
            ...
            className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-coral-500 px-4 py-2.5 text-sm font-semibold text-teal-900 shadow-[0_8px_24px_-12px_rgba(184,137,90,0.7)] transition-colors hover:bg-coral-600 sm:w-auto"
          >
